...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://user_standard:sourcecode10@127.0.0.1:3306/checkinapp'
...
api.add_resource(TotalHours, '/totalhours/<string:username>/<string:start_date>/<string:end_date>') # GET
